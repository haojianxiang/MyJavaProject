...
public class DBPlatformContactPipeline extends DBHelper implements Pipeline {
	...
	public static final String  INSERT_SQL="INSERT INTO platform_contact(taskId, person, mobilephone, email, website ) "
			+"VALUES(?, ?, ?, ?, ?) ";
...
//		ps.setString(18,map.get("website_url")+"");
		...
		ps.setString(1,null);
		ps.setString(2,map.get("person")+"");
		ps.setString(3,map.get("mobilephone")+"");
		ps.setString(4,map.get("email")+"");
		ps.setString(5,map.get("website")+"");
